...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    // İçerik renklerinin tema ile uyumlu olması için ValueListenableBuilder ile sarıyoruz
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, isDark, _) {
        ...
        // YENİ EKLENDİ: Dış kabuk olarak MasterLayout kullanıldı
        return MasterLayout(
          ...
          floatingActionButton: FloatingActionButton.extended(
            ...
            backgroundColor: isDark ? primaryColor.withOpacity(0.2) : const Color(0xFFFEE8E1),
            elevation: 0,
            ...
            label: Text('Yeni Tarif', style: GoogleFonts.nunito(color: primaryColor, fontWeight: FontWeight.w800)),
          ),
